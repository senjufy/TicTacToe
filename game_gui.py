        ...
        for y in x:
            if y == 1:
                ...
                pygame.draw.line(screen, green, (x_pos * 100 + 15, y_pos * 100 + 85),
                                 (x_pos * 85 + 85, y_pos * 100 + 15), line_width)
            if y == -1:
...
def draw_winner(winner):
    ...
    pygame.draw.rect(screen, green, (screen_width // 2 - 100, screen_height // 2 - 66, 200, 50))
